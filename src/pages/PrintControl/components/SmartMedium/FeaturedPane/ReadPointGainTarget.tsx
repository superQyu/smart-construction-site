...
export default function ReadPointGainTarget({ params = {} }: Props) {
          ...
          <Grid item xs={12} sm={12} md={7} className="sm:max-h100% max-h100% h-full">
            ...
            >
              <Box sx={{ p: '25px 30px' }}>
                ...
                >
                  {t('readPointGainTarget.overview', '智能媒体管理器需要从网点增益目标读取测量数据。')}
                </Typography>
              </Box>
            </SubCard>
            <SubCard
            ...
            >
              <Box sx={{ p: '25px 30px' }}>
                <Typography sx={{ fontWeight: 700, mb: '15px' }}>
                  {t('readPointGainTarget.process.process1', '1、等待油墨在打印目标上完全干燥。')}
                </Typography>
                <Typography sx={{ fontWeight: 700, mb: '15px' }}>
                  {t('readPointGainTarget.process.process2', '2、测量并导入扫描仪生成的数据文件中的StatusT值。')}
                </Typography>
                <Typography sx={{ fontWeight: 700, mb: '15px' }}>
                  {t('readPointGainTarget.process.process3', '3、查看着色剂曲线预览。')}
                </Typography>
                <Typography sx={{ fontWeight: 700 }}>
                  {t('readPointGainTarget.process.process4', '4、继续下一步。')}
                </Typography>
              </Box>
            </SubCard>
