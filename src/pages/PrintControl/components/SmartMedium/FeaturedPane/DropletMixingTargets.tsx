...
export default function DropletMixingTargets({ params = {} }: Props) {
          ...
          <Grid item xs={12} sm={12} md={7} className="sm:max-h100% max-h100% h-full">
            ...
            >
              <Box sx={{ p: '25px 30px' }}>
                ...
                >
                  {t(
                    'PrintDropletMixingTargets.overview',
                    '智能媒体管理器需要通过打印和测量各种测试目标来获取打印机的降电平行为。',
                  )}
                </Typography>
              </Box>
            </SubCard>
            ...
            >
              <Box sx={{ p: '25px 30px' }}>
                <Typography sx={{ fontWeight: 700, mb: '15px' }}>
                  {t(
                    'process.process1',
                    '1、点击“打印目标”按钮，使用智能打印控制器打印您的测试目标。',
                  )}
                </Typography>
